...
- **非连续存储**：元素在内存中分布不连续，迭代器是双向迭代器（参看 [[学习/编程语言/C++/STL/Iterator/Iterator分类]]），支持++/--，不支持随机访问
...
- [[学习/编程语言/C++/STL/Container/Set]]
- [[学习/编程语言/C++/重载运算符]] — 自定义 key 需要重载 <
- [[学习/编程语言/C++/Lambda]]
- [[学习/编程语言/C++/STL/Template]]
- [[学习/课程/MIT6.006-算法导论/Lecture4：Hashing]] — 与哈希表对比
