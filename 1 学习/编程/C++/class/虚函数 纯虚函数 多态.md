...
但当该指针调用子和父拥有的同名函数时，真正调用的是父的函数（这就是为什么需要 [[1 学习/编程/C++/class/继承|继承]] + 虚函数来支持动态绑定），而我们期望调用的是子的那个函数
...
- [[1 学习/编程/C++/class/继承]]
- [[1 学习/编程/C++/class/This指针]] — 普通函数依赖 this
- [[1 学习/编程/C++/class/静态]]
- [[1 学习/编程/C++/class/构造函数和析构函数]] — 析构可以是虚函数
- [[1 学习/编程/C++/类型转换]] — dynamic_cast 依赖虚表
