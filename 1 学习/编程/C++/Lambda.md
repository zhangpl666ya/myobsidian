...
- 兼容 STL 算法（如 `std::sort`、`std::for_each`）、回调函数、异步逻辑等场景；Lambda 本质是匿名类并[[1 学习/编程/C++/重载运算符|重载了 `operator()`]]。
...
- 若 Lambda 有捕获，无法转换为函数指针（需用 `std::function` 封装——可对比 [[1 学习/编程/Python/可调用协议]] 的思路）。
...
- [[1 学习/编程/C++/重载运算符]] — lambda 是 operator() 的语法糖
- [[1 学习/编程/C++/STL/Template]]
- [[1 学习/编程/Python/自定义函数/Lambda]]
- [[1 学习/编程/Python/可调用协议]]
- [[1 学习/编程/C/函数指针的意义]]
